...
__global__ void gpu_hypterm_xy_stencil_kernel(
	...
	__shared__ double      s_qv[BLOCK_DIM_Y+NG+NG][${shared_pad}];
	__shared__ double   s_qpres[BLOCK_DIM_Y+NG+NG][${shared_pad}];
	__shared__ double    s_cons[BLOCK_DIM_Y+NG+NG][${shared_pad}];
